...
\input{Coatings.tex}
\newpage
\input{Cryogenics.tex}
\newpage
\input{Newtonian_Noise.tex}
\newpage
\input{Suspension_and_Isolation.tex}
\newpage
\input{Light_Sources.tex}

\newpage
\input{Quantum_Enhancements.tex}
\newpage
\input{Aux_Optics.tex}
\newpage
\input{Sim_and_Control.tex}
\newpage
\input{Summary.tex}
\newpage
% references
...
\bibliography{Biblio/2017references}
